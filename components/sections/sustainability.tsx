...
export function Sustainability() {
  return (
    <section
      id="sustainability"
      className="relative bg-[color:var(--color-paper)] py-24 lg:py-32"
    >
          ...
          <div className="sticky top-28">
            <Reveal>
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-sm bg-[color:var(--color-bone)]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-7 text-[color:var(--color-cream)]">
          ...
          <div className="mt-12 grid sm:grid-cols-2 gap-x-8 gap-y-2">
            {SUSTAINABILITY.pillars.map((p, i) => (
              <Reveal
                key={p.title}
                delay={0.15 + i * 0.06}
                className="border-t border-[color:var(--border-primary)] py-6"
              >
                <div className="flex items-baseline gap-3">
                  ...
                  <div>
                    <h4 className="font-display text-xl leading-tight tracking-[-0.01em]">
                      {p.title}
                    </h4>
